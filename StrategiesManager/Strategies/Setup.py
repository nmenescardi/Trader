class StrategiesSetup():
	...
	config = {
		...
		RSI_OverSold : [
			...
			{'ticker': 'MRNA', 'rsi_period' : 2, 'rsi_limit': 5, 'tp_percentage': 15 }, # Manual TP	
			...
			{'ticker': 'SNOW', 'rsi_period' : 5, 'rsi_limit': 15, 'tp_percentage': 4 },	# Manual TP
			...
			{'ticker': 'TWLO', 'rsi_period' : 25, 'rsi_limit': 25, 'tp_percentage': 5 },	
